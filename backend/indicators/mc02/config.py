...
# 1. CODIGOS PRESTACIONALES SEGUN FICHA TECNICA MC-02
CODIGOS_ESTANDAR = {
    ...
    "ANEMIA": {"D509", "D649"},
    "HIERRO": {"99199.17"},
    "MULTIMICRONUTRIENTES": {"99199.19"},
    "TELEMEDICINA_EXCLUIDA": {"99499"},
}

# 2. REGLAS DE NEGOCIO Y EXCLUSIONES
REGLAS_NEGOCIO = {
    "META_COBERTURA_MENSUAL": DEFAULT_TARGET_COVERAGE,
    "PROVINCIA_DEFECTO": DEFAULT_PROVINCE,

    # En MC-02 el tipo de seguro viene en DATOS_GENERALES -> Obs_Niño.
    "COLUMNA_TIPO_SEGURO": "Obs_Niño",
    "SEGUROS_INCLUIDOS": {"SIS", "NINGUNO", "SIN SEGURO", "SIN_SEGURO", ""},

    # El archivo operativo ya marca la poblacion evaluada con Registros = 1.
    ...
    # Decision operativa local para Red de Salud Abancay.
...
RESUMEN = {
    ...
    "Cred_cumple": {
        "descripcion": "Indica si cumple con CRED"
    },
    ...
    "Obs_Anemia": {
        "descripcion": "Observación de anemia"
    },
